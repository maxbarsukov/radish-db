...
defmodule RadishDB.Raft.Communication.Leadership do
  ...
  defun follower_responded(
          %__MODULE__{quorum_timer_started_at: started_at, follower_responded_times: times} = l,
    ...
    new_times =
      ...
      # filter by the actual members, in order not to be disturbed by message from already-removed member
      |> Map.take(follower_pids)
